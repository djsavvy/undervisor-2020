...
void simple_tests() {
    ...
    printf(
        "VALID: SimpleDerived* sd1_2 (%p) casted up to SimpleBase* sb_2 (%p)\n",
        sd1_2, sb_2);
    ...
    printf(
        "Starting with SimpleDerived2* sd2_1: pushed back 0x6f, 0x6f, 0x70, "
        "0x73 to sd2_1->sd2_member2\n");
    SimpleDerived2* sd2_1 = new SimpleDerived2();
    ...
    printf(
        "INVALID: SimpleDerived2* sd2_1 (%p) casted up to SimpleBase* sb_3 "
        "(%p), then casted down to SimpleDerived3* sd3_1 (%p)\n",
        sd2_1, sb_3, sd3_1);
